# ME 751 HW 6 problem 2
#Alex Dawson-Elli

#generate desired system properties and print them out
...
#-----------------------------print sim quantities at t = 0---------------------
SE3D.buildɸF(sim)   ; print("ɸF   = ") ; println(sim.ɸF)
SE3D.buildɸF_q(sim) ; print("ɸF_q = ") ;  println(sim.ɸF_q)
SE3D.buildνF(sim)   ; print("ν = ")    ; println(sim.νF)
SE3D.build𝛾F(sim)   ; print("𝛾 = ")    ; println(sim.𝛾F)
